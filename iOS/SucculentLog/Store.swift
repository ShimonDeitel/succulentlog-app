...
final class Store: ObservableObject {
    ...
    private let fileName = "succulentlog_items.json"
    ...
    /// Adding sub-log entries (Propagation Log) is the Pro feature.
    @discardableResult
    ...
    static func seedItems() -> [Item] {
        [
        Item(name: "Echeveria elegans", primaryField: "4in terracotta", secondaryField: "", notes: "Mexican hens-and-chicks, rosette form"),
        Item(name: "Haworthia fasciata", primaryField: "3in ceramic", secondaryField: "", notes: "Zebra plant, striped leaves"),
        Item(name: "Crassula ovata", primaryField: "6in clay", secondaryField: "", notes: "Jade plant, thick woody stems"),
        ]
    }
}
